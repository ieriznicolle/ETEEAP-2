...
<div id="page-container">
	...
	<div id="settings">
		...
		&nbsp;
		<div class="adsettings">
			<form name="form" action="settings?act=adminsettings" method="post">
				<button type="submit" value="ADSETTINGS"><img class="imgsetting" src="img/admin.png" alt="admin settings"/>
				<br>Admin Settings<br><i>(add, edit, and delete users)</i></button>
			</form>
		</div>
	</div>
