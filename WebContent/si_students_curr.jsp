	...
	<div class="coursecurr">
		...
		<form name="form" action="students?act=curriculum" method="post">
			<table class="pd">
				...
				<c:forEach var="course" items="${course.rows}">
				<tr>
					<td style="text-align: left;"><c:out value="${course.code}"/></td>
					<td style="text-align: left;"><c:out value="${course.title}"/></td>
					<td class="c_units"><c:out value="${course.units}"/></td>
					<td class="c_hours"><c:out value="${course.tuition}"/></td>
					<td><textarea class="cd" name="cd" maxlength="1000" rows="2" cols="20"></textarea></td>
					<td><select class="evidence" name="evidence">
							<option value="Evidence" disabled selected></option>
					...
					<td><input type="text" class="cct" name="cct" size="15"/></td>
			...
			<table class="assess">
				<tr>
					...
					<td>Date:</td>
					<td><input type="date" class="assessed" name="assessed0"/></td>
				</tr>
				<tr></tr>
				<tr>
					<td>Assessed by:</td>
					<td><select class="assessor" name="assessor1">
							<option value=" " selected> </option>
							<c:forEach var="a" items="${assessors.rows}">
								<option value="${a.name}"><c:out value="${a.name}"/></option>
							</c:forEach>
					...
					<td>_____________________</td>
					<td>Date:</td>
					<td><input type="date" class="assessed" name="assessed1"/></td>
				</tr>
				<tr></tr>
				<tr>
					<td>Assessed by:</td>
					<td><select class="assessor" name="assessor2">
							<option value=" " selected> </option>
							<c:forEach var="a" items="${assessors.rows}">
								<option value="${a.name}"><c:out value="${a.name}"/></option>
							</c:forEach>
					...
					<td>_____________________</td>
					<td>Date:</td>
					<td><input type="date" class="assessed" name="assessed2"/></td>
				</tr>
			</table>
