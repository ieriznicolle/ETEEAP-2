						...
						<form name="addform" action="settings?act=adduser" method="post">	
							...
							<div class="aed" align="center">
								<table>
									...
									<tr>
										<td>Username:</td><td><input type="text" name="username" pattern="[a-zA-Z ]+" placeholder ="jkdelacruz" required onkeyup="checkExist()"/></td>
									</tr>
									<tr>
										<td>Position:</td><td><input type="text" name="position" pattern="[a-zA-Z ,/()&-]+" placeholder ="Director" required></td>
									</tr>
									<tr>
					...
					<div class="modal-header">
						...
						<form name="editform" action="settings?act=editusera" method="post">
							<div class="aede" align="center">
								...
								<input type="text" pattern="[0-9]{5}" name="empnum_" maxlength="5" placeholder ="XXXXX" required onkeyup="check()"/>
								<br><br>
					...
					<div class="modal-header">
						...
						<form name="deleteform" action="settings?act=deleteuser" method="post">
							...
							<div class="aede" align="center">
								...
								<input type="text" pattern="[0-9]{5}" name="empnum" maxlength="5" placeholder ="XXXXX" required onkeyup="check()"/>
								<br><br>
...
<script>
	...
	var dspan = document.getElementsByClassName("close")[2];
	...
	window.onclick = function(event) {
		if (event.target == amodal || event.target == emodal ||event.target == dmodal) {
			amodal.style.display = "none";
	    	emodal.style.display = "none";
	    	dmodal.style.display = "none";
	  	}
