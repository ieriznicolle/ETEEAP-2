...
<div id="page-container">
	...
	<div id="setting">
		<div id="adsettings">
			<form name="form" action="settings?act=adminsettings" method="post">
				<button type="submit" value="ADSETTINGS"><img id="imgsetting" src="img/admin.png" alt="admin settings"/></button>
			</form>
		</div>
			...
			<form name="form" action="settings?act=changepw" method="post">
				...
				<div class="s_table" align="center">
					<table>
						...
						<tr>
							<td colspan=2 style="font-size: 12px; color: #CD3B3B;"><i>*You will be logged out from your account for the changes to be made.</i></td>
						</tr>
					</table>
				</div>
				<br>
